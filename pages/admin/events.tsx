...
export default function EventsPage() {
  ...
  const handleEdit = (event: Event) => {
    setFormData({
      ...
      venue: event.venue || '',
      themeColor: event.themeColor || '#00CBB3',
    })
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#201751] via-[#16123D] to-[#201751] text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <Calendar className="w-8 h-8 text-[#00CBB3]" />
              <div>
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-[#00CBB3] to-[#00CBB3] hover:from-[#009B8A] hover:to-[#009B8A] text-[#16123D] px-4 py-2 rounded-lg transition-all font-semibold"
          >
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
        {/* Create/Edit Form */}
        {showForm && (
          <div className="bg-gradient-to-br from-[#16123D]/60 to-[#7600FF]/20 backdrop-blur border border-white/10 rounded-xl p-6 mb-8 animate-slide-in">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-gray-400 focus:border-[#00CBB3] focus:outline-none transition"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#00CBB3] focus:outline-none transition"
                  />
                </div>
                <div>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-[#00CBB3] to-[#00CBB3] hover:from-[#009B8A] hover:to-[#009B8A] text-[#16123D] px-6 py-2 rounded-lg transition-all font-semibold"
                >
        ...
        {events.length === 0 ? (
          <div className="bg-gradient-to-br from-[#16123D]/40 to-[#7600FF]/10 backdrop-blur border border-white/10 rounded-xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#00CBB3] to-[#00CBB3] hover:from-[#009B8A] hover:to-[#009B8A] text-[#16123D] px-6 py-2 rounded-lg transition-all font-semibold inline-flex items-center gap-2"
            >
              <Plus className="w-5 h-5" />
              Create Event
            </button>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold group-hover:text-[#00CBB3] transition-colors">{event.name}</h3>
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-semibold ${
                      event.status === 'LIVE'
                        ? 'bg-[#00CBB3]/20 text-[#00CBB3]'
                        : event.status === 'PUBLISHED'
                        ? 'bg-[#7600FF]/20 text-[#B266FF]'
                ...
                <div className="flex gap-2 pt-4 border-t border-white/10">
                  <button
                    ...
                    className="flex-1 bg-[#7600FF]/20 hover:bg-[#7600FF]/30 text-[#B266FF] py-2 rounded-lg transition-colors text-sm font-medium flex items-center justify-center gap-2"
                  >
